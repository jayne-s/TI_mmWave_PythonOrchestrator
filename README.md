...
Captured data is forwarded via UDP packets through a packet sniffer and stored in a file, which is later uploaded to MinIO for downstream processing. This architecture is designed to extend naturally to multiple simultaneous radars, although that is currently out of scope and has not been tested yet.
